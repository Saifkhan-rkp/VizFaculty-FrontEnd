                            ...
                            {auth
                                ...
                                <div className="flex space-x-2">
                                    <Link
                                        to={"/auth/register"}
                                        title="Sign Up"
                                        className=" text-center justify-center text-sky-900 bg-gray-300 hover:bg-gray-400 focus:ring-4 focus:ring-sky-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none lg:visible">
                                        Sign Up
                                    </Link>
                                    <Link
                                        to={"/auth/login"}
